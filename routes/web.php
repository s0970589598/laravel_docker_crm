...
Route::group(['prefix' => 'clients'], function () {
    Route::get('ie', 'ImExport\ClientsImExportController@index')->name('clientsIEport');
    Route::post('import', 'ImExport\ClientsImExportController@import');
    Route::get('export', 'ImExport\ClientsImExportController@export');
...
Route::group(['prefix' => 'sales'], function () {
    ...
    Route::post('import', 'ImExport\SalesImExportController@import');
    Route::get('export', 'ImExport\SalesImExportController@export');
