        ...
        <div class="col-md-3 col-sm-12 col-xs-12">
            <div class="panel panel-primary text-center no-boder bg-color-green">
                <div class="panel-body boxes">
                    ...
                    <h3 style="padding:8px;font-size:18px">{{trans('views.index.box_clients')}} {{ Cache::get('countClients') }}
                ...
                <a href="{{ route('clients') }}" style="text-decoration: none">
                    <div class="panel-footer back-footer-green boxes-font">
                        {{ Cache::get('clientsInLatestMonth') }} {{trans('views.index.box_info')}}
                    </div>
                </a>
            </div>
        </div>
        <div class="col-md-3 col-sm-12 col-xs-12">
            <div class="panel panel-primary text-center no-boder bg-color-blue">
                <div class="panel-body boxes">
                    ...
                    <h3 style="padding:8px;font-size:18px">{{trans('views.index.box_companies')}} {{ Cache::get('countCompanies') }}
                ...
                <a href="{{ route('companies') }}" style="text-decoration: none">
                    <div class="panel-footer back-footer-blue boxes-font">
                        {{ Cache::get('companiesInLatestMonth') }} {{trans('views.index.box_info')}}
                    </div>
                </a>
            </div>
        </div>
        <div class="col-md-3 col-sm-12 col-xs-12">
            <div class="panel panel-primary text-center no-boder bg-color-red">
                <div class="panel-body boxes">
                    ...
                    <h3 style="padding:8px;font-size:18px">{{trans('views.index.box_employees')}} {{ Cache::get('countFinances') }}
                ...
                <a href="{{ route('employees') }}" style="text-decoration: none">
                    <div class="panel-footer back-footer-red boxes-font">
                        {{ Cache::get('employeesInLatestMonth') }} {{trans('views.index.box_info')}}
                    </div>
                </a>
            </div>
        </div>
        <div class="col-md-3 col-sm-12 col-xs-12">
            <div class="panel panel-primary text-center no-boder bg-color-brown">
                <div class="panel-body boxes">
                    ...
                    <h3 style="padding:8px;font-size:18px">{{trans('views.index.box_deals')}} {{ Cache::get('countDeals') }}
                ...
                <a href="{{ route('deals') }}" style="text-decoration: none">
                    <div class="panel-footer back-footer-brown boxes-font">
                        {{ Cache::get('dealsInLatestMonth') }} {{trans('views.index.box_info')}}
                    </div>
                </a>
            </div>
        </div>
                        ...
                        @if(count($dataWithAllTasks) > 0)
                            @foreach ($dataWithAllTasks as $result)
                                <a href="{{ URL::to('tasks/view/' . $result['id']) }}" class="list-group-item">
                                    ...
                                    <span class="badge badge"
                                          style="background-color: #ca4e6e !important;">{{trans('views.index.latest_tasks_duration')}} {{ $result['duration'] . ' days' }}</span>
