...
@section('caption', '【產品列表】List of products')

@section('title', '【產品列表】List of products')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ URL::to('products/form/create') }}">
                <button type="button" class="btn btn-primary btn active">新增產品</button>
            </a>
            <br><br>
            <div class="panel panel-default">
                <div class="panel-heading">
                    <i class="fa fa-keyboard-o" aria-hidden="true"></i> 【產品列表】List of products
                </div>
                                ...
                                <tr class="odd gradeX">
                                    ...
                                    <td class="text-center">
                                        <button type="submit"
                                                ...
                                                <!--{{ Cknow\Money\Money::{App\Models\SettingsModel::getSettingValue('currency')}($value->price) }}-->
                                                {{ '$' . ($value->price) }}
                                            </button>
                                    </td>
                                    <td class="text-center">
                                    ...
                                    <td class="text-right">
                                        <div class="btn-group">
                                            <a class="btn btn-small btn-primary"
                                               href="{{ URL::to('products/view/' . $value->id) }}">更多資訊</a>
                                            <button data-toggle="dropdown" class="btn btn-primary dropdown-toggle"><span
                                                        class="caret"></span></button>
                                            <ul class="dropdown-menu">
                                                <li>
                                                    <a href="{{ URL::to('products/form/update/' . $value->id) }}">修改</a>
                                                </li>
                                                <!--<li class="divider"></li>
