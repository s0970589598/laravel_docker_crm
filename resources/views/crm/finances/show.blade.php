                ...
                <div class="panel-body">
                    ...
                    <div class="tab-pane fade active in" id="home">
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tr>
                                <th>Gross</th>
                                <td>{{ '$' . ($finance->gross) }}<!--{{ Cknow\Money\Money::{config('crm_settings.currency')}($finance->gross) }}--></td>
                            </tr>
                            <tr>
                                <th>Net</th>
                                <td>{{ '$' . ($finance->net) }}<!--{{ Cknow\Money\Money::{config('crm_settings.currency')}($finance->net) }}--></td>
                            </tr>
                            <tr>
                                <th>Vat</th>
                                <td>{{ '$' . ($finance->vat) }}<!--{{ Cknow\Money\Money::{config('crm_settings.currency')}($finance->vat) }}--></td>
                            </tr>
                            <tr>
                                <th>Date</th>
                                <td>{{ $finance->date }}</td>
