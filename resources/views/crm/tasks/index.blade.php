...
@section('caption', '【任務】List of tasks')

@section('title', '【任務】List of tasks')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <a href="{{ URL::to('tasks/form/create') }}">
                <button type="button" class="btn btn-primary btn active">新增任務</button>
            </a>
            <br>
            <!-- Advanced Tables -->
            <h4 class="page-header">
                <i class="fa fa-code-fork" aria-hidden="true"></i> 未完成任務
            </h4>
                    ...
                    <div class="table">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example" data-sortable>
                            ...
                            <tr>
                                ...
                                <th class="text-center">指派</th>
                                <th class="text-center">期間</th>
                                <th class="text-center">狀態</th>
                                <th class="text-center">完成</th>
                                <th class="text-center" style="width:300px">動作</th>
                            </tr>
                            </thead>
                            <tbody>
                                        ...
                                        <td class="text-right">
                                            @if($value->completed == FALSE)
                                                <a href="{{ URL::to('tasks/completed/' . $value->id) }}">
                                                    <button type="button" class="btn btn-completed small-btn">標註完成</button>
                                                </a>
                                            @else
                                                <a href="{{ URL::to('tasks/uncompleted/' . $value->id) }}">
                                                    <button type="button" class="btn btn-completed small-btn">標註未完成</button>
                                                </a>
                                            @endif
                                            <a class="btn btn-small btn-success small-btn"
                                               href="{{ URL::to('tasks/view/' . $value->id) }}">更多資訊</a>
                                            <a class="btn btn-small btn-info small-btn"
                                               href="{{ URL::to('tasks/form/update/' . $value->id) }}">修改</a>
                                        </td>
                                    </tr>
                                @endif
                            @endforeach
            ...
            <!-- Advanced Tables -->
            <h4 class="page-header">
                <i class="fa fa-code-fork" aria-hidden="true"></i>【已完成任務】 List of completed tasks
            </h4>
            <div class="panel panel-default">
                <div class="panel-body">
                                        ...
                                        <td class="text-right">
                                            @if($values->completed == FALSE)
                                                <a href="{{ URL::to('tasks/completed/' . $values->id) }}">
                                                    <button type="button" class="btn btn-completed small-btn" style="background-color: grey !important; border-color: grey">標註未完成</button>
                                                </a>
                                            @else
